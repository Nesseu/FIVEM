    ...
    if _itemValue == 'caldopollo' then
        SetTimeout(10000, function()        
            ...
            if alephQuantity < 1 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') .. _U('packaged_chicken') .. '')
            elseif bethQuantity < 1 then
                TriggerClientEvent('esx:showNotification', _source, _U('not_enough') ..'agua' .. '')
            else
                    TriggerClientEvent('esx:showNotification', _source, _U('craft') .. _U('caldopollo') .. ' !')
