...
Config.Zones = {
    ...
    Vaults = {
        Pos   = { x = -705.71, y = -913.17, z = 18.215587615967 },    
    ...
    Tienda = {
        ...
        Type  = 23,
        Items = {
            { name = 'cocacola', label = 'Cocacola', price = 5 },
            { name = 'ensalada', label = 'Ensalada', price = 5 },
            { name = 'palomitas', label = 'Palomitas de mantequilla', price = 5 },
            { name = 'bocadillo', label = 'Bocadillo', price = 5 },
            { name = 'cigarrillo', label = 'Cigarrillo', price = 5 },
            { name = 'phone', label = 'VallePhone', price = 50 },
            { name = 'shovel', label = 'Pala', price = 200 }
        },
    },
